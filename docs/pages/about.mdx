...
<div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
    ...
    Der Python-Profi und Scrummaster des Projekts. Silas kann (fast) alles programmieren – solange es mit Python zu tun hat. Vielseitig und für jede Aufgabe zu haben.
</div>
